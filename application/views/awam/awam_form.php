...
<html>
    ...
    <body>
        <h2 style="margin-top:0px">Awam <?php echo $button ?></h2>
	    ...
	    <input type="hidden" name="awid" value="<?php echo $awid; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('awam') ?>" class="btn btn-default">Cancel</a>
	</form>
    </body>
</html>